export const ru: Record<string, string> = {
  ...
  "Dmytro, 28 — marketing specialist": "Дмитрий, 28 — специалист по маркетингу",
  "Social anxiety & perfectionism": "Социальная тревожность и перфекционизм",
  "“When the panic starts, I have a 3-minute grounding routine that actually works.”": "“Когда начинается паника, у меня есть 3-минутная заземляющая рутина, которая действительно работает.”",
  ...
  "Kateryna, 29 — teacher": "Катерина, 29 — учитель",
  "Overwhelm & emotional regulation": "Перегрузка и эмоциональная регуляция",
  "“A short evening check-in helped me stop scrolling and go to sleep earlier.”": "“Короткая вечерняя проверка помогла мне прекратить пролистывание и лечь спать раньше.”",
  ...
  "“I didn’t need a perfect plan. I needed one small next step — and I got it.”": "“Мне не нужен был идеальный план. Мне нужен был один маленький следующий шаг — и я его получил.”",
  "Oksana, 24 — junior designer": "Оксана, 24 — младший дизайнер",
  "Self-doubt & job search": "Неуверенность в себе и поиск работы",
  "“Instead of catastrophizing, I wrote down facts. The fear got smaller.”": "“Вместо того чтобы катастрофизировать, я записала факты. Страх стал меньше.”",
  "Artem, 22 — student": "Артем, 22 — студент",
  "Overthinking & exam anxiety": "Чрезмерное обдумывание и тревога перед экзаменом",
  "“I can finally say ‘I need time to think’ without freezing.”": "“Я наконец могу сказать ‘Мне нужно время, чтобы подумать’, не замирая.”",
  "Yulia, 30 — QA engineer": "Юлия, 30 — инженер по качеству",
  "Fear of mistakes & pressure at work": "Страх ошибок и давление на работе",
  "“Before talking to family, I talk here — and it becomes easier.”": "“Перед тем как говорить с семьей, я говорю здесь — и становится легче.”",
  "Natalia, 37 — HR": "Наталья, 37 — HR",
  "Relationship stress & boundaries": "Стресс в отношениях и границы",
  ...
  "Decision fatigue & burnout risk": "Усталость от принятия решений и риск выгорания",
  ...
  "Viktoriia, 31 — project manager": "Виктория, 31 — менеджер проектов",
  "Anxiety spikes & overload": "Приступы тревоги и перегрузка",
  ...
  "Olena, 27 — customer support": "Олена, 27 — служба поддержки клиентов",
  ...
  "Sleep issues & rumination": "Проблемы со сном и размышления",
