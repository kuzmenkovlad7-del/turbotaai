export const ru: Record<string, string> = {
  ...
  "Helps reduce the feeling of loneliness in difficult moments.":
    "Помогает уменьшить чувство одиночества в тяжёлые моменты.",
  ...
  "Gives a stronger feeling that someone is really next to you.":
    "Дает ощущение, что рядом действительно есть кто-то поддерживающий.",
  ...
  "Not sure which format? Start with a safe chat":
    "Если сомневаетесь — начните с безопасного чата",
  ...
  "There was an issue with the voice call. Please try again.":
    "Во время голосового звонка произошла ошибка. Пожалуйста, попробуйте ещё раз.",
  "There was an issue with the video call. Please try again.":
    "Во время видеозвонка произошла ошибка. Пожалуйста, попробуйте ещё раз.",

  // ─────────────────────
  // Блок преимуществ (ServiceFeatures)
  // ─────────────────────
  "Support in minutes when it feels really bad":
    "Поддержка за считаные минуты, когда действительно очень плохо",
  "Open chat, voice or video exactly when it feels bad right now — без очередей, анкет и ожидания записи.":
    "Откройте чат, голос или видео именно в тот момент, когда плохо прямо сейчас — без очередей, анкет и ожидания записи.",
  "Feels like a calm, respectful human conversation":
    "Ощущается как спокойный, уважительный разговор с человеком",
  ...
  "Contact Page Description":
    "Напишите нам, если вам нужна поддержка, консультация или вы хотите обсудить сотрудничество.",
  ...
  "All questions about the service, payments, access to the assistant or cooperation — please write to this address.":
    "По всем вопросам о сервисе, оплате, доступе к ассистенту или сотрудничестве — пожалуйста, пишите на этот адрес.",
  ...
  "“After a week with TurbotaAI I finally slept through the night without panic thoughts.”":
    "«После недели с TurbotaAI я наконец-то спала всю ночь без панических мыслей.»",
  ...
  "On difficult days Max launched a short voice session on the way to the office. Together with the assistant they unpacked what exactly he was afraid of in upcoming meetings and rehearsed several phrases that would help him stay in the adult position.":
    "В сложные дни Макс запускал короткую голосовую сессию по дороге в офис. Вместе с ассистентом они разбирали, чего именно он боится на предстоящих встречах, и проговаривали несколько фраз, которые помогали сохранять взрослую позицию.",
  ...
  "After a month he noticed that he no longer cancelled calls at the last moment and could say “I need time to think about it” instead of freezing in silence. These are small steps, but they gave him back a feeling of control.":
    "Через месяц он заметил, что больше не отменяет звонки в последний момент и может сказать «Мне нужно время, чтобы обдумать» вместо того, чтобы замирать в тишине. Это небольшие шаги, но они вернули ему ощущение контроля.",

  "Sofia, 19 — first-year student":
    "София, 19 — студентка первого курса",
  "From “no one understands me” to small routines":
    "От «меня никто не понимает» к маленьким рутинам",
  "“It’s easier to write to the AI first and only then to friends — when I understand what I really feel.”":
    "«Мне легче сначала написать ИИ, а уже потом друзьям — когда я понимаю, что на самом деле чувствую.»",
  ...
  "Sofia moved from a small town to another city to study. In the dorm she felt lonely, ashamed of “weakness” and did not want to burden her parents with her worries.":
    "София переехала из маленького города в другой, чтобы учиться. В общежитии она чувствовала себя одинокой, стеснялась своей «слабости» и не хотела нагружать родителей своими переживаниями.",
  ...
  "Sofia found two people with whom she now goes to classes, and created a small evening routine instead of doomscrolling. She still experiences anxiety, but she no longer feels completely alone with it.":
    "София нашла двух людей, с которыми теперь ходит на занятия, и создала небольшую вечернюю рутину вместо бесконечного скролла. Тревога никуда не исчезла, но она больше не остаётся с ней совсем одна.",
  ...
  "You can start with a one-time session and later switch to regular support or a program for your team.":
    "Можно начать с разовой сессии, а затем перейти к регулярной поддержке или программе для вашей команды.",
  ...
  "Companies that care about emotional state of employees.":
    "Компании, которым важно эмоциональное состояние сотрудников.",
  ...
  "Payment integration will be configured together with you. Now we focus on the quality of support and the scenarios of the assistant.":
    "Интеграцию оплаты мы настроим вместе с вами. Сейчас мы фокусируемся на качестве поддержки и сценариях работы ассистента.",

  // ─────────────────────
  // Условия пользования (Terms of Use) — заголовки
  // ─────────────────────
  ...
  "• Teenagers 12–18 who need a safe space to talk about emotions and self-esteem.":
    "• Подростки 12–18 лет, которым нужно безопасное пространство, чтобы говорить о чувствах и самооценке.",
  ...
  "• Clarifying questions instead of 20 tips at once — the assistant tries to understand your state.":
    "• Уточняющие вопросы вместо 20 советов сразу — ассистент пытается понять ваше состояние.",
  "• Breathing, grounding, short exercises, diary of emotions, small daily steps.":
    "• Дыхательные упражнения, граунд-практики, небольшие упражнения, дневник эмоций, маленькие ежедневные шаги.",
  ...
  "• In crisis or risk of harm to yourself or others, you should contact emergency services or a human specialist.":
    "• В кризисе или при риске причинить вред себе или другим необходимо обращаться в экстренные службы или к живому специалисту.",
  "• The assistant is a supportive tool that can live alongside individual or group therapy.":
    "• Ассистент — это вспомогательный инструмент, который может существовать рядом с индивидуальной или групповой терапией.",
  ...
  "On the first launch we plan to test the service with a free period, so that users can safely try the assistant and we can see how people really use TurbotaAI.":
    "На запуске мы планируем протестировать сервис с бесплатным периодом, чтобы пользователи могли безопасно попробовать ассистента, а мы — увидеть, как люди реально используют TurbotaAI.",
  "After testing you can keep a small free part (for example, a few questions) and then switch to a simple paid model: a monthly subscription for regular support and a one-time access option for those who want to try a single extended session.":
    "После тестирования можно оставить небольшую бесплатную часть (например, несколько вопросов), а дальше перейти на простую платную модель: помесячную подписку для регулярной поддержки и разовый доступ для тех, кто хочет попробовать одну расширенную сессию.",
  "All payments will be processed through a certified payment provider, and refunds will be handled manually through support e-mail if something goes wrong.":
    "Все платежи будут проходить через сертифицированного платёжного провайдера, а возвраты мы будем обрабатывать вручную через e-mail поддержки, если что-то пойдёт не так.",
  ...
  "You can start with one sentence: for example, 'I feel anxious and can't sleep', 'I can't concentrate', or 'I don't know what to do in a relationship'.":
    "Можно начать с одного предложения, например: «Я тревожусь и не могу уснуть», «Я не могу сосредоточиться» или «Я не знаю, что делать в отношениях».",
  ...
  "are at least 18 years of age;":
    "вам исполнилось как минимум 18 лет;",

  "have the legal capacity to enter into a contract;":
    "вы обладаете полной дееспособностью для заключения договоров;",
  ...
  "use the Service in any way that may violate the law or the rights of third parties.":
    "использовать Сервис любым образом, который может нарушать закон или права третьих лиц.",
  ...
  "You agree not to use the Service to send insults, threats, spam, advertising or any other unwanted or illegal content.":
    "Вы соглашаетесь не использовать Сервис для отправки оскорблений, угроз, спама, рекламы или любого другого нежелательного либо незаконного контента.",
  ...
  "If you violate these Terms, or if we reasonably believe that your behaviour may harm the Service or other users, we may temporarily restrict or terminate your access to the Service.":
    "Если вы нарушаете эти Условия или мы обоснованно считаем, что ваше поведение может навредить Сервису или другим пользователям, мы можем временно ограничить или прекратить ваш доступ к Сервису.",
  ...
  "By continuing to use the Service after the new Terms come into effect, you agree to the updated Terms. If you do not agree with the changes, you must stop using the Service.":
    "Продолжая пользоваться Сервисом после вступления в силу новых Условий, вы соглашаетесь с ними. Если вы не согласны с обновлёнными Условиями, вы должны прекратить использование Сервиса.",
  ...
  "If you have any questions about these Terms of Use, you can contact us via the contact form on the website or by using the e-mail address listed in the \"Contact\" section.":
    "Если у вас есть вопросы по этим Условиям пользования, вы можете связаться с нами через форму обратной связи на сайте или по электронной почте, указанной в разделе «Контакты».",
  ...
  "This Privacy Policy explains what information TurbotaAI collects, how we use it and how we protect it. We design the Service to respect your privacy and personal boundaries.":
    "Эта Политика конфиденциальности объясняет, какую информацию собирает TurbotaAI, как мы её используем и защищаем. Мы проектируем Сервис так, чтобы уважать вашу приватность и личные границы.",

  "By using the Service, you agree to the terms of this Policy. If you do not agree, please do not use the Service.":
    "Пользуясь Сервисом, вы соглашаетесь с условиями этой Политики. Если вы не согласны с ней, пожалуйста, не используйте Сервис.",
  ...
  "e-mail address if you submit it for contact or registration;":
    "адрес электронной почты, если вы оставляете его для контакта или регистрации;",
  ...
  "When you use chat, voice or video assistant, we process the content of your messages, spoken input or text in order to generate responses and guidance. Depending on settings, some of this data may be temporarily stored to:":
    "Когда вы используете чат-, голосового или видео-ассистента, мы обрабатываем содержание ваших сообщений, голосовых запросов или текста, чтобы формировать ответы и рекомендации. В зависимости от настроек часть этих данных может временно сохраняться для:",
  ...
  "We may also collect technical data, such as:":
    "Мы также можем собирать технические данные, такие как:",

  "IP address and approximate location;":
    "IP-адрес и примерное местоположение;",

  "information about your device, browser and operating system;":
    "информация о вашем устройстве, браузере и операционной системе;",

  "cookies and similar technologies required for the Service to work and for analytics.":
    "cookie-файлы и аналогичные технологии, необходимые для работы Сервиса и аналитики.",
  ...
  "to communicate with you (for example, responses to requests, important notifications).":
    "общения с вами (например, ответы на запросы, важные уведомления).",
  ...
  "We apply technical and organisational security measures to protect data from unauthorised access, loss or misuse. These may include encryption, access controls, log audits and other cybersecurity practices.":
    "Мы применяем технические и организационные меры безопасности, чтобы защитить данные от несанкционированного доступа, потери или злоупотребления. К ним могут относиться шифрование, разграничение прав доступа, аудит логов и другие практики кибербезопасности.",
  ...
  "However, no online system can guarantee absolute security. You also play a role in keeping your data safe — for example, by not sharing your credentials with others and by using strong passwords (if user accounts are introduced).":
    "Однако ни одна онлайн-система не может гарантировать абсолютную безопасность. Вы также играете важную роль в защите своих данных — например, не передавая учётные данные третьим лицам и используя надёжные пароли (если аккаунты будут введены).",

  "We retain data only for as long as necessary to fulfil the purposes described in this Policy or as required by law.":
    "Мы храним данные только столько, сколько это необходимо для достижения целей, описанных в этой Политике, или пока этого требует закон.",
  ...
  "Conversation history and technical logs may be deleted or anonymised after a certain period of time. In the future the interface may include settings that allow you to delete your history yourself.":
    "История диалогов и технические логи могут удаляться или анонимизироваться через определённый период. В будущем интерфейс может включать отдельные настройки, чтобы вы могли самостоятельно удалять свою историю.",
  ...
  "To operate the Service we may use third-party providers such as hosting companies, payment processors, video platforms or AI model providers.":
    "Для работы Сервиса мы можем использовать сторонних поставщиков — например, хостинг-провайдеров, платёжные системы, платформы видеосвязи или поставщиков AI-моделей.",
  ...
  "These providers may process your data on our behalf and in accordance with our instructions. We aim to work only with entities that follow appropriate data protection standards.":
    "Такие поставщики могут обрабатывать ваши данные от нашего имени и в соответствии с нашими инструкциями. Мы стремимся сотрудничать только с компаниями, которые придерживаются надлежащих стандартов защиты данных.",
  ...
  "Because infrastructure may be located in different countries, your data may sometimes be transferred outside the country where you live. We take steps to ensure that such transfers comply with applicable data protection laws.":
    "Поскольку инфраструктура может быть размещена в разных странах, ваши данные иногда могут передаваться за пределы страны вашего проживания. Мы принимаем меры, чтобы такая передача соответствовала требованиям применимого законодательства о защите данных.",
  ...
  "TurbotaAI is not intended for independent use by children under the age of 13. If you are under 18, parental or guardian consent may be required under the laws of your country.":
    "TurbotaAI не предназначена для самостоятельного использования детьми младше 13 лет. Если вам меньше 18, согласие родителей или опекунов может быть обязательным в соответствии с законодательством вашей страны.",
  ...
  "If we become aware that we have collected personal data from a child without appropriate consent, we will take steps to delete such information.":
    "Если мы узнаем, что собрали персональные данные ребёнка без надлежащего согласия, мы предпримем шаги для их удаления.",
  ...
  "ask us to correct inaccurate information;":
    "просить нас исправить неточную информацию;",

  "request deletion of certain data (where we are not required to keep it by law);":
    "запрашивать удаление части данных (если мы не обязаны хранить их по закону);",

  "object to or restrict certain types of processing; and":
    "возражать против определённых способов обработки или ограничивать их; и",
  ...
  "We may update this Privacy Policy from time to time. The date of the latest update is shown at the top of this page.":
    "Мы можем время от времени обновлять эту Политику конфиденциальности. Дата последнего обновления указана вверху страницы.",
  ...
  // Кнопка отправки в чат-ассистенте
  Send: "Отправить",

  // Три ключа с поправками по аналогии с украинской версией
  "Female voice": "ЖЕНСКИЙ ГОЛОС",
  "Male voice": "МУЖСКОЙ ГОЛОС",
  ...
  // ─────────────────────
  // Client stories – rotating testimonials (auto)
