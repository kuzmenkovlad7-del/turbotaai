export const uk: Record<string, string> = {
  ...
  // ─────────────────────
  "AI companion nearby 24/7": "Підтримка 24/7",
  ...
  "Call AI companion": "Голосова розмова з AI співрозмовником",
  ...
  "“After a week with TurbotaAI I finally slept through the night without panic thoughts.”":
    "«Після тижня з TurbotaAI я нарешті спала всю ніч без панічних думок.»",
  ...
  "Sofia, 19 — first-year student":
    "Софія, 19 — студентка першого курсу",
  ...
  "First steps & anxiety": "Перші кроки в терапії та тривога",
}
