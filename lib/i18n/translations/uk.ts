export const uk: Record<string, string> = {
  ...
  "“I stopped rewriting messages ten times. Now I send them — and breathe.”": "“Я перестав переписувати повідомлення десять разів. Тепер я їх відправляю — і дихаю.”",
  "Dmytro, 28 — marketing specialist": "Дмитро, 28 — спеціаліст з маркетингу",
  "Social anxiety & perfectionism": "Соціальна тривога та перфекціонізм",
  "“When the panic starts, I have a 3-minute grounding routine that actually works.”": "“Коли починається паніка, у мене є 3-хвилинна рутина заземлення, яка насправді працює.”",
  "Iryna, 32 — entrepreneur": "Ірина, 32 — підприємець",
  "Panic episodes & body sensations": "Панічні епізоди та тілесні відчуття",
  "“I learned to name the feeling first — and only then decide what to do.”": "“Я навчився спочатку називати відчуття — а вже потім вирішувати, що робити.”",
  "Kateryna, 29 — teacher": "Катерина, 29 — вчителька",
  "Overwhelm & emotional regulation": "Перевантаження та емоційна регуляція",
  "“A short evening check-in helped me stop scrolling and go to sleep earlier.”": "“Коротка вечірня перевірка допомогла мені припинити гортати та лягти спати раніше.”",
  "Andrii, 41 — operations manager": "Андрій, 41 — менеджер з операцій",
  "Stress, insomnia & constant tension": "Стрес, безсоння та постійне напруження",
  "“I didn’t need a perfect plan. I needed one small next step — and I got it.”": "“Мені не потрібен був ідеальний план. Мені потрібен був один маленький наступний крок — і я його отримав.”",
  "Oksana, 24 — junior designer": "Оксана, 24 — молодший дизайнер",
  "Self-doubt & job search": "Сумніви в собі та пошук роботи",
  "“Instead of catastrophizing, I wrote down facts. The fear got smaller.”": "“Замість того, щоб катастрофізувати, я записав факти. Страх став меншим.”",
  "Artem, 22 — student": "Артем, 22 — студент",
  "Overthinking & exam anxiety": "Переміркування та тривога перед іспитом",
  "“I can finally say ‘I need time to think’ without freezing.”": "“Я нарешті можу сказати ‘Мені потрібен час, щоб подумати’ без заморожування.”",
  "Yulia, 30 — QA engineer": "Юлія, 30 — інженер з контролю якості",
  "Fear of mistakes & pressure at work": "Страх помилок та тиск на роботі",
  "“Before talking to family, I talk here — and it becomes easier.”": "“Перед тим, як говорити з родиною, я говорю тут — і стає легше.”",
  ...
  "Viktoriia, 31 — project manager": "Вікторія, 31 — менеджер проєктів",
  ...
  "Svitlana, 33 — analyst": "Світлана, 33 — аналітик",
  ...
  "Olena, 27 — customer support": "Олена, 27 — служба підтримки клієнтів",
  ...
  "Sleep issues & rumination": "Проблеми зі сном та обдумування",
  ...
  "First steps in therapy & anxiety": "Перші кроки в терапії та тривога",
}
