        ...
        <div className="space-y-8 text-muted-foreground">
          ...
          <section>
            ...
            <div className="space-y-4">
              <ul className="ml-2 list-inside list-disc space-y-2">
                <li>
                  Providing personalized AI psychology support tailored to your
                  needs
                </li>
                <li>
                  Maintaining conversation history to improve continuity across
                  sessions
                </li>
                <li>
                  Analyzing aggregate data to enhance our AI models and service
                  quality
                </li>
                <li>
                  Sending service updates, security alerts, and important
                  notifications
                </li>
                <li>
                  Ensuring platform security and preventing fraudulent
                  activities
                </li>
                <li>
                  Complying with legal obligations and responding to lawful
                  requests
                </li>
              </ul>
            </div>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <ul className="ml-2 list-inside list-disc space-y-2">
                <li>
                  <strong>End-to-End Encryption:</strong> All conversations are
                  encrypted during transmission and at rest
                </li>
                <li>
                  <strong>Secure Authentication:</strong> Password protection
                  with modern hashing algorithms
                </li>
                <li>
                  <strong>Access Controls:</strong> Strict internal policies
                ...
                <li>
                  <strong>Data Isolation:</strong> Your data is isolated and
                  never mixed with other users
                </li>
              </ul>
              <p className="mt-4">
                While we take extensive precautions, no internet transmission is
                completely secure. We encourage you to protect your account
                credentials and contact us immediately if you suspect
                unauthorized access.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <p className="mt-4">
                ...
                support@turbotaai.com. We will respond to your request within 30
                days.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <ul className="ml-2 list-inside list-disc space-y-2">
                <li>
                  Active account data is retained while your account remains
                  active
                </li>
                <li>
                  Session transcripts are retained for 12 months to enable
                  continuity of care
                </li>
                <li>
                  Deleted accounts are fully purged within 90 days, except where
                  retention is required by law
                </li>
                <li>
                  Anonymous usage analytics may be retained indefinitely for
                  service improvement
                </li>
              </ul>
            </div>
          ...
          <section>
            ...
            <div className="space-y-4">
              <p>
                We work with trusted third-party services to deliver our
                platform:
              </p>
              <ul className="ml-2 list-inside list-disc space-y-2">
                <li>Cloud infrastructure providers for secure data storage</li>
                <li>
                  Payment processors for transaction handling (we never store
                  payment card details)
                </li>
                <li>
                  Analytics services for understanding service usage patterns
                </li>
              </ul>
              <p className="mt-4">
                All third-party providers are bound by strict data protection
                agreements and only process data on our behalf.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <ul className="ml-2 list-inside list-disc space-y-2">
                ...
                <li>
                  Verification that receiving countries provide adequate data
                  protection
                </li>
                <li>
          ...
          <section>
            ...
            <div className="space-y-4">
              <p>
                ...
                you of significant changes via email or through prominent notice
                on our platform. Continued use of our services after such
