      ...
      <div className="max-w-4xl mx-auto bg-card rounded-3xl shadow-lg p-8 md:p-12">
        ...
        <div className="space-y-8 text-muted-foreground">
          ...
          <section>
            ...
            <div className="space-y-4">
              <p>Our AI psychology services are designed to provide supportive conversations and psychological insights. However, you acknowledge and understand that:</p>
              <ul className="list-disc list-inside space-y-2 ml-2">
                <li>Our AI service is not a substitute for professional medical or psychiatric treatment</li>
                <li>The AI cannot diagnose medical or mental health conditions</li>
                <li>In case of emergency or crisis, you should immediately contact emergency services or a crisis hotline</li>
                <li>Our service is intended for informational and support purposes only</li>
                <li>Any actions you take based on interactions with our AI are at your own discretion and risk</li>
              </ul>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 ml-2">
                ...
                <li>Modify or create derivative works based on our service</li>
                <li>Distribute, transmit, or publicly display our content</li>
          ...
          <section>
            ...
            <div className="space-y-4">
              <p>Our pricing structure is clearly displayed on our platform. By purchasing our services, you agree to:</p>
              <ul className="list-disc list-inside space-y-2 ml-2">
              ...
              <p className="mt-4">We reserve the right to modify our pricing at any time. Changes will be communicated in advance and will not affect active subscriptions until renewal.</p>
            </div>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4 text-foreground">Cancellation and Refunds</h2>
            <div className="space-y-4">
              <p>You may cancel your subscription at any time through your account settings. Cancellations will take effect at the end of your current billing period.</p>
              <p>Refunds are provided on a case-by-case basis at our sole discretion. Generally:</p>
              <ul className="list-disc list-inside space-y-2 ml-2">
                <li>Unused credits may be eligible for prorated refunds</li>
                <li>Technical issues preventing service access may warrant refunds</li>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <p className="mt-4">Our total liability for any claims arising from your use of the service shall not exceed the amount you paid to us in the twelve months preceding the claim.</p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              <p>We reserve the right to suspend or terminate your account and access to our services at our sole discretion, without notice, for conduct that we believe:</p>
              <ul className="list-disc list-inside space-y-2 ml-2">
              ...
              <p className="mt-4">Upon termination, your right to use the service will immediately cease, but provisions regarding intellectual property, disclaimer of warranties, limitation of liability, and indemnification will survive.</p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              <p>We reserve the right to modify or replace these Terms of Use at any time at our sole discretion. Material changes will be notified through:</p>
              <ul className="list-disc list-inside space-y-2 ml-2">
                <li>Email notification to your registered address</li>
                <li>Prominent notice on our platform</li>
                <li>In-app notifications</li>
              </ul>
              <p className="mt-4">Your continued use of our services after such modifications constitutes your acceptance of the updated terms. We encourage you to review these terms periodically.</p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              <p>If any provision of these Terms of Use is found to be unenforceable or invalid, that provision will be limited or eliminated to the minimum extent necessary so that these terms will otherwise remain in full force and effect.</p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div className="ml-2 mt-4">
                <p><strong>Email:</strong> legal@myitra.com</p>
